    ...
    <section className="relative flex flex-col items-center justify-start pt-64 pb-16 px-4 text-center min-h-screen overflow-hidden -mt-16">
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <div className="mb-16 max-w-2xl">
          <ShinyText
            text="Unlock partnerships, customers, revenue at scale with Network AI."
            className="text-md md:text-lg tracking-normal font-[400]"
            speed={5}
          />
        </div>
        ...
        <div className="mb-16 w-full max-w-2xl px-4">
          <label
            ...
            className="block text-sm font-medium text-foreground mb-3 text-left"
          >
            Try it Now!
          </label>
        ...
        <div className="flex flex-col items-center space-y-6">
          <ShinyText
            text="TRUSTED BY TOP COMPANIES"
            className="text-sm tracking-normal font-medium"
            speed={5}
          />
          <div className="flex items-center justify-center gap-12 opacity-60">
            {[
              ...
              { src: "/vapi-logo.png", alt: "Vapi" },
              { src: "/parallel-logo.png", alt: "Parallel" },
              { src: "/fireworks-logo.png", alt: "Fireworks" },
            ].map((logo, index) => (
              <div
                key={index}
